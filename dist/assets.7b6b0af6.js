...
function importJSON() {
  fetch('slideInfo.json').then(function (response) {
...
function repairCardText() {
  document.querySelectorAll("#cardTitle, #cardDescription").forEach(function (element) {
    d3plus.textwrap().container(d3.select(element)).resize(false).draw();
  });
}
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","assets.js"], null)
//# sourceMappingURL=assets.7b6b0af6.js.map